...
const navLinks = [
  { label: 'Work', href: '#photography', sub: '01' },
  // { label: 'Filmography', href: '#filmography', sub: '02' },
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-end h-full px-8 md:px-16 pb-16">
          ...
          <div
            className="nav-social-item flex items-center justify-between border-t border-opacity-10 pt-6"
		...
		c-30.254,0-48.284,20.38-56.202,40.08c-2.897,7.012-3.602,16.861-3.602,26.711v184.047H177.124L177.124,500.219z"
              ...
              <a
                ...
                className="text-dimmed-ink hover:text-accent-color transition-colors duration-300 font-sans text-sm font-light"
