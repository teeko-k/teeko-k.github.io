...
export default function Hero() {
  ...
  return (
    <section
      className="bg-color-bg relative h-screen 2xl:h-[80vh] flex flex-col justify-end overflow-hidden"
      id="home"
    >
      {/* Background Gradient */}
      ...
      <div className="relative z-10 px-8 md:px-12 pb-20 md:pb-24 2xl:max-w-[70%] 2xl:mx-auto flex flex-col items-start text-left">
        ...
        {/* Main heading */}
        <h1 className="font-display w-full md:w-[55%] 2xl:w-[45%] leading-none mb-8">
          <span
